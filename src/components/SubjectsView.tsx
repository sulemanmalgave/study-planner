...
export default function SubjectsView({
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto pb-12" id="subjects-view-container">
      {/* Top Header */}
      <div className="flex flex-wrap items-center justify-between gap-4 bg-white p-5 rounded-3xl border border-[#E1E3E1] shadow-2xs" id="subjects-header">
        ...
        <button
          ...
          className="px-4 py-2.5 bg-[#6750A4] hover:bg-[#503E84] text-white rounded-2xl text-xs font-bold flex items-center gap-2 transition-all shadow-sm cursor-pointer"
      ...
      {courses.length === 0 ? (
        ...
        <div className="bg-white border border-[#E1E3E1] rounded-3xl p-12 text-center max-w-lg mx-auto space-y-4 my-8 shadow-2xs" id="subjects-empty-state">
          ...
          <button
            onClick={handleOpenAdd}
            className="px-6 py-3 bg-[#6750A4] hover:bg-[#503E84] text-white text-xs font-bold rounded-2xl inline-flex items-center gap-2 shadow-sm transition-all cursor-pointer"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" id="subjects-grid">
          {courses.map((course) => {
            ...
            return (
              <div
                key={course.id}
                className="bg-white rounded-3xl border border-[#E1E3E1] p-5 hover:shadow-md transition-all flex flex-col justify-between space-y-4 group"
      ...
      {isAddModalOpen && (
        ...
        >
          <div className="w-full max-w-md bg-white border border-slate-200 rounded-3xl p-6 shadow-2xl space-y-4" id="subject-form-modal-card">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-3 flex items-center justify-end gap-2 border-t border-slate-100">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-[#6750A4] hover:bg-[#503E84] text-white rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all shadow-sm cursor-pointer disabled:opacity-50"
      ...
      {deletingCourse && (
        ...
        >
          <div className="w-full max-w-md bg-white border border-slate-200 rounded-3xl p-6 shadow-2xl space-y-4" id="subject-delete-modal-card">
