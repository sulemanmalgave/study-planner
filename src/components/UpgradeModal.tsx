...
import { X, Check, Sparkles, ShieldCheck, Zap, CreditCard, ArrowRight, Loader2, AlertCircle, Globe, UserCheck, LogIn } from 'lucide-react';
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-5 text-left">
              ...
              <div className="space-y-1.5">
                ...
                {authUser ? (
                  ...
                  <div className="p-3.5 bg-amber-50/90 border border-amber-200/80 rounded-2xl space-y-2.5">
                    ...
                    <button
                      ...
                      className="w-full py-2 px-3 bg-white hover:bg-amber-50 text-slate-800 text-xs font-bold border border-amber-300/80 rounded-xl shadow-xs flex items-center justify-center gap-2 transition-all cursor-pointer disabled:opacity-50"
