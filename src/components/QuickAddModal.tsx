...
export default function QuickAddModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in" id="quick-add-backdrop">
      <div className="relative w-full max-w-md bg-[#131d31] border border-slate-700/60 rounded-2xl shadow-2xl overflow-hidden flex flex-col" id="quick-add-card">
        ...
        <div className="grid grid-cols-4 border-b border-slate-850 p-1.5 bg-[#0e1627]">
          <button
            ...
            className={`py-2 text-[10px] font-black uppercase rounded-lg flex flex-col items-center gap-1 transition-all ${
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <button
            ...
            className="w-full py-3 bg-blue-600 hover:bg-blue-500 text-xs font-bold text-white rounded-xl transition-all shadow-md flex items-center justify-center gap-1.5"
          >
            {isSubmitting ? (
              <>
